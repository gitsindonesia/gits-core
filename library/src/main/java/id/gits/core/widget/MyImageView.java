...
/**
 * Special version of ImageView which allow enlarge width of image if
 * android:adjustViewBounds is true.
 * 
 * <p>
 * This simulate HTML behaviour &lt;img src="" widh="100" /&gt;
 * </p>
 * <p>
 * <a href=
 * "http://stackoverflow.com/questions/6202000/imageview-one-dimension-to-fit-free-space-and-second-evaluate-to-keep-aspect-rati"
 * >Stackoverflow question link
 * </p>
 * 
 * @author Tom� Proch�zka &lt;<a
 *         href="mailto:tomas.prochazka@atomsoft.cz">tomas
 *         .prochazka@atomsoft.cz</a>&gt;
